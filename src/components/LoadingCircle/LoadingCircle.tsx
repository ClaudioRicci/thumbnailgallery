...
const LoadingCircle: React.SFC<LoadingCircleProps> = props => {
  return (
    <>
      <div className="loading-circle" data-testid="loadingCircle">
        <h1 className="loading-circle__title">{props.message}</h1>
        <svg
          width="160"
          height="48"
          viewBox="0 0 160 48"
          className="loading-circle__logo"
        >
        ...
        <div className="loading-circle__loader"></div>
      </div>
    </>
  );
};
